...
export function HomePage() {
  return (
    <div>
      {/* Hero */}
      <section className="relative min-h-[80vh] md:min-h-[90vh] flex items-center pt-20 md:pt-24 pb-8 md:pb-16 overflow-hidden">
        ...
        <div className="container-ultra relative w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8 items-end">
            <div className="lg:col-span-8">
              <div className="eyebrow mb-4 md:mb-6 animate-fade-up">
              ...
              <h1 className="display-xl mb-4 md:mb-8 animate-fade-up stagger-1">
              ...
              <p className="text-base md:text-lg mb-6 md:mb-10 animate-fade-up stagger-2 leading-relaxed" style={{ color: 'var(--muted)', maxWidth: '52ch' }}>
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-3 animate-fade-up stagger-3">
            ...
            <div className="lg:col-span-4 animate-fade-up stagger-4 mt-6 lg:mt-0">
              <HeroPreview />
            </div>
          </div>
        </div>
      ...
      {/* Manifesto section */}
      <section className="py-12 md:py-24 border-t" style={{ borderColor: 'var(--border)' }}>
        <div className="container-wide">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
            <div className="md:col-span-4">
              <div className="eyebrow mb-3 md:mb-4">How this is different</div>
              <h2 className="display-md">
                No scores. <em>No "best choice" badges.</em> Just numbers.
              </h2>
            </div>
            <div className="md:col-span-7 md:col-start-6 space-y-6 md:space-y-8 pt-2 md:pt-4">
              <Principle
                num="01"
                title="Show the math"
      ...
      <section className="py-12 md:py-24 border-t" style={{ borderColor: 'var(--border)' }}>
        <div className="container-wide">
          <div className="eyebrow mb-3 md:mb-4">Where to start</div>
          <h2 className="display-md mb-8 md:mb-16">Four ways in. <em>Pick the one that fits.</em></h2>
      ...
      {/* Stats / credibility */}
      <section className="py-12 md:py-24 border-t" style={{ borderColor: 'var(--border)', background: 'var(--ink)', color: 'var(--paper)' }}>
        <div className="container-wide">
      ...
      {/* Safety notice */}
      <section className="py-8 md:py-16 border-t" style={{ borderColor: 'var(--border)' }}>
        <div className="container-narrow">
          <div className="eyebrow mb-3 md:mb-4" style={{ color: 'var(--danger)' }}>Safety notice</div>
          ...
          <p className="text-sm md:text-base leading-relaxed mt-3 md:mt-4" style={{ color: 'var(--muted)' }}>
...
function EntryPath({ num, title, body, link, cta, accent }: {
  ...
  return (
    <Link
      to={link}
      className="group block p-6 md:p-10 transition-colors"
    ...
    >
      ...
      <h3 className="display-md mb-2 md:mb-3 tracking-tight">{title}</h3>
      <p className="text-sm leading-relaxed mb-4 md:mb-6" style={{ color: 'var(--muted)', maxWidth: '40ch' }}>
        {body}
      </p>
